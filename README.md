...
```bibtex
@misc{german-hate-speech-2026,
  author = {[Your Name]},
  title = {German Hate Speech Classification: Comparing Language-Specific BERT Models},
  year = {2026},
  publisher = {GitHub},
  url = {https://github.com/[your-username]/german-hate-speech-classification}
}
```

And cite the original GermEval 2018 dataset:

```bibtex
@inproceedings{wiegand-etal-2018-overview,
  title = "Overview of the {G}erm{E}val 2018 Shared Task on the Identification of Offensive Language",
...
**Status:** ✅ All experiments completed | 📊 4 experiments | 🏆 GBERT best model | 📈 Results ready for publication
